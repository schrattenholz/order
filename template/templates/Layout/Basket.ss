   ...
   <div class="container">
        <div class="row">
		  ...
		  <tr id="$ID_$Variant01_$Vac">
				  ...
				  <td>$Title $PriceBlockElementID</td>
				  <td>$Quantity</td>
				  ...
				  <td><a href="javascript:removeProductFromBasket('$ID','$Variant01','$Vac','$ID_$Variant01_$Vac');" title="Produkt aus dem Warenkorb entfernen"><i class="fas fa-trash-alt"></i></a></td>
				</tr>
		  <% end_loop %>
