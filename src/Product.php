...
class Product extends Page
{
	...
	public function getSummaryTitle(){
		...
		return $sumTitle;//." mit ".$this->Wheels." R�dern";
	}
	public function onBeforeWrite(){
		//Sortierunreiheienfolge wird gesetzt, wenn die �bergeordnete Sortierung ver�ndert wurde
 	...
 	public function getCMSFields()
	{
		...
		$fields->addFieldToTab("Root.Main",new ListboxField("Addons", "Art der Bearbeitung",Addon::get()->map("ID", "Title", "Bitte ausw�hlen")),"Content");
		...
		$unit=new DropdownField("UnitID","Einheit",Unit::get()->map("ID", "Title", "Bitte ausw�hlen"));
		...
		$fields->addFieldToTab("Root.Main",new ListboxField("Ingredients", "Zutaten",Ingredient::get()->map("ID", "Title", "Bitte ausw�hlen")),"Content");
